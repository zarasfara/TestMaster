...
`\src\TestMaster.Presentation\bin\Release\net10.0-windows10.0.19041.0\win-x64\AppPackages\TestMaster.Presentation_0.0.1.0_Test`

## Установка

На устройстве пользователя устанавливаем сертификат:

1. Двойным кликом: `TestMaster.Presentation_0.0.1.0_x64.cer`
...
```powershell
Add-AppxPackage -Path .\TestMaster.Presentation_0.0.1.0_x64.msix
```
